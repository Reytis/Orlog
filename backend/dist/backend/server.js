...
import { makeGame } from '../orlog/src/machine/gameMachine.js';
import { subStates } from '../orlog/src/types.js';
const app = express();
...
const gameRooms = {}; // Stocker les salles de jeu
io.on('connection', (socket) => {
    var _a;
    const userId = (_a = socket.handshake.query.userId) === null || _a === void 0 ? void 0 : _a.toString(); // Récupérer l'ID utilisateur fourni par le client
    if (!userId) {
    ...
    socket.on('updateGameStateWithAllPlayerValidation', (roomId, event, player) => {
